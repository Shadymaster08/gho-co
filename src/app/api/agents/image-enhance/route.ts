...
const PROMPTS: Record<string, string> = {
  ...
  lighting: `Keep the lighting product exactly as it is — preserve its shape, structure and all physical details. Place it against a deep dark grey (#111111) background — not pure black, so the product structure remains clearly visible. The product should appear softly illuminated from within or around it, with its glow adding atmosphere without overpowering the form. Balanced between dramatic and informative: you can see both the product itself and its light effect. Subtle surface reflection below the product. Professional commercial photography, cinematic quality.`,
