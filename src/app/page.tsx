    ...
    <div className="min-h-screen bg-[#0c0c0c] text-white">
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 pt-14">
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          <p
            className="animate-fade-up mb-5 text-xs font-medium uppercase tracking-[0.2em] text-white/30"
            style={{ animationDelay: '0ms' }}
          >
            Gho&amp;Co Custom Shop — Canada
          </p>
          <h1
            className="animate-fade-up text-[clamp(3rem,10vw,6rem)] font-bold leading-[0.95] tracking-tighter text-white"
            style={{ animationDelay: '80ms' }}
          >
            Made exactly<br />the way you want it.
          </h1>
          <p
            className="animate-fade-up mx-auto mt-7 max-w-lg text-lg leading-relaxed text-white/40"
      ...
      <section id="products" className="mx-auto max-w-6xl px-6 py-24">
        <p className="animate-fade-up mb-2 text-xs font-medium uppercase tracking-[0.15em] text-white/30">
          What we make
        </p>
        <h2 className="animate-fade-up mb-12 text-3xl font-bold tracking-tighter text-white sm:text-4xl">
          Four ways we can build for you.
        </h2>

        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {products.map(({ icon: Icon, title, description, href, tag }, i) => (
            <Link
              key={href}
              href={href}
              className="animate-fade-up group relative flex flex-col rounded-2xl border border-white/[0.08] bg-[#141414] p-7 transition-all duration-300 hover:-translate-y-1 hover:border-white/20 hover:bg-[#1a1a1a] hover:shadow-[0_20px_40px_rgba(0,0,0,0.6)]"
      ...
      <section className="mx-auto max-w-6xl px-6 py-24">
        ...
        <h2 className="animate-fade-up mb-16 text-3xl font-bold tracking-tighter text-white sm:text-4xl">
      ...
      <section className="relative overflow-hidden border-t border-white/[0.06] px-6 py-28 text-center">
        ...
        <div className="relative mx-auto max-w-2xl">
          <h2 className="animate-fade-up text-3xl font-bold tracking-tighter text-white sm:text-4xl">
            Ready to create something?
          </h2>
          <p
            className="animate-fade-up mx-auto mt-4 max-w-sm text-base text-white/40"
            style={{ animationDelay: '80ms' }}
          >
          ...
          <Link
            href="/register"
            className="animate-fade-up mt-8 inline-flex rounded-full bg-white px-8 py-3 text-base font-medium text-black transition-colors hover:bg-white/90"
            style={{ animationDelay: '160ms' }}
          >
